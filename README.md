...
Assim que a aplicação estiver de pé, fica disponível em: [localhost:8080/api/swagger-ui/#/](https://throyer-crud-api.herokuapp.com/api/documentation/swagger-ui/#/)
